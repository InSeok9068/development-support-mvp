...
- [PocketBase JavaScript SDK](#pocketbase-javascript-sdk)
  - [Installation](#installation)
    - [Browser (manually via script tag)](#browser-manually-via-script-tag)
    - [Node.js (via npm)](#nodejs-via-npm)
  - [Usage](#usage)
  - [Caveats](#caveats)
  ...
  - [Definitions](#definitions)
    - [Creating new client instance](#creating-new-client-instance)
